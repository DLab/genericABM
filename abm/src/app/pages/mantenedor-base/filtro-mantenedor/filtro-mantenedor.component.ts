...
export class FiltroMantenedorComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  ngOnInit() {
    ...
    let ctr:any = this;
    this.filterComponent['search']=function(){
      ctr.search();
    }
  }
  ...
  isValid(){
    return this.initOk && (this.filterComponent['isValid'] == undefined || (typeof(this.filterComponent['isValid']) == 'function' ? this.filterComponent['isValid']() : this.filterComponent['isValid']));
  }
  visibleSearch(){
    return this.filterComponent['visibleSearch'] ?  this.filterComponent['visibleSearch']()  : true;
  }
}
