...
export function getAnaliticsOptions(xaxis:any[], series:any[], title:string, caption:string, xAxisLabel:string, yAxisLabel:string){
  ...
  tooltip: {
    ...
    valueFormatter: (value) => value.toFixed ? getFormatNumber(value, 2) : value
  },
  grid:{height: '75%'},
  xAxis: {
    name: xAxisLabel,
  ...
  dataZoom: [
    {
      textStyle: {
        color: '#ccc' // Color del texto sobre fondo oscuro
      },
      bottom: "55",
      handleIcon: 'path://M10.7,11.9v-1.3H9.3v1.3c-4.9,0.3-8.8,4.4-8.8,9.4c0,5,3.9,9.1,8.8,9.4v1.3h1.3v-1.3c4.9-0.3,8.8-4.4,8.8-9.4C19.5,16.3,15.6,12.2,10.7,11.9z M13.3,24.4H6.7V23h6.6V24.4z M13.3,19.6H6.7v-1.4h6.6V19.6z',
      handleStyle: {
        color: '#888' // Color del "handle"
      },
      dataBackground: {
        areaStyle: {
          color: '#333' // Fondo gris oscuro, usa '#000' para negro
        },
        lineStyle: {
          opacity: 0.8,
          color: '#ccc' // Línea visible sobre fondo oscuro
        }
      },
      brushSelect: true
    },
