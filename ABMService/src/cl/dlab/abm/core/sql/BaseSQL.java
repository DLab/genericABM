...
import cl.dlab.abm.core.gen.EntityType;
import cl.dlab.abm.core.gen.FieldType;
import cl.dlab.abm.core.gen.QueryType;
import cl.dlab.abm.core.gen.Type;
...
import cl.dlab.abm.util.MassiveLoadThread;
...
public class BaseSQL
{
	...
	public static EntityType getEntity(Class<? extends BaseSQL> c) throws Exception
	{
		try
		{
			...
			synchronized (entities)
			{
				...
				File file = new File(PropertyUtil.BASE + "resources/cl/dlab/abm/core/sql/abm/" + c.getSimpleName());
				if (!file.exists())
				{
					return null;
				}
	...
	public Connection newConnection() throws Exception 
	{
		if (con == null)
		{
			...
			String datasource = entity == null ? null : entity.getDatasource();
	...
	public Object getMaxId(HashMap<String, Object> input) throws Exception 
	{
		...
		try
		{
			//System.out.println("maxId:" + entity.getSelectMaxId());
	...
	private <Input extends InputVO, Output extends VOBase> RespuestaVO<Output> _consultar(HashMap<String, Object> hash, Input input) throws Exception
	{
		...
		{
			Output out = (Output)input.getOutputClass().getDeclaredConstructor().newInstance();
